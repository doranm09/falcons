...
A verification step compares scanner reachability reports against the PID inventory and
fails if any expected cyber nodes are unreachable, ensuring that the emulated network
matches the baseline before proceeding to risk analysis.
